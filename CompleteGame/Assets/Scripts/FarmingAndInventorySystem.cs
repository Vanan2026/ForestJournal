...
namespace ForestJournal
{
    ...
    public class GameDate
    {
        ...
        public int year = 1;
        public FarmWeatherType weather = FarmWeatherType.Sunny;
        ...
        public void NextDay()
        {
            ...
            if (rand < 0.4f) weather = FarmWeatherType.Sunny;
            else if (rand < 0.7f) weather = FarmWeatherType.Cloudy;
            else if (rand < 0.9f) weather = FarmWeatherType.Rainy;
            else weather = FarmWeatherType.Stormy;
        }

        public bool IsRainySeason => weather == FarmWeatherType.Rainy || weather == FarmWeatherType.Stormy;
    }
